        ...
        <div class="site-size__our-production-container">
            ...
            <div class="our-production-container__content">
                <div class="content__tabs-row">
                    <?php
                        foreach ($args['cats'] as $k => $cat):
                            ...
                            ?>
                            <div class="tabs-row__tab f <?php echo $class;?>" data-count="-1" data-post-type="products" data-cat-id="<?php echo $cat['id']; ?>" data-p="0">
                ...
                <div class="content__subtabs subterms-target">
                    <div class="subtabs__subtab current" data-count="-1" data-post-type="products"  data-p="0">
                        <span class="subtab__text"><?php _e('Все', 'chicken'); ?></span>
                    </div>
                    <?php foreach ($args['subcats'] as $subcat): if($subcat['parent'] !== 0):?>
                        <div class="subtabs__subtab" data-tag-id="<?php echo $subcat['id']; ?>" data-tag-s="<?php echo $subcat['slug']; ?>" data-count="-1" data-post-type="products"  data-p="0">
